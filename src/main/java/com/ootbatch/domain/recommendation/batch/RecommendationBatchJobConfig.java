...
import com.ootbatch.domain.recommendation.listener.RecommendationJobExecutionListener;
import com.ootbatch.domain.recommendation.listener.RecommendationStepExecutionListener;
import com.ootbatch.domain.recommendation.step.RecommendationItemProcessor;
import com.ootbatch.domain.recommendation.step.RecommendationItemWriter;
...
public class RecommendationBatchJobConfig {
     ...
     */
    @Bean
    public JpaPagingItemReader<Long> recommendationUserIdItemReader() {
        return new JpaPagingItemReaderBuilder<Long>()
                .name("recommendationUserIdItemReader")
    ...
    public Step generateRecommendationsStep() {
        ...
        return new StepBuilder("generateRecommendationsStep", jobRepository)
                ...
                .reader(recommendationUserIdItemReader())
